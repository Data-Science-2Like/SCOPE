"""
    This source file is copied from the 3.8.3 version of the gensim library:
    https://github.com/RaRe-Technologies/gensim/blob/e889fa3d45a406cabbc7e180fa9a8ee3f76ac6f0/gensim/summarization/bm25.py
    At the bottom of this file, we have additionally added
    the effective_n_jobs function from the gensim utils.py file with the required imports.
    The reason for all of this is that the AAE-Recommender requires a more recent version of the gensim library
    and since version 4 this file containing the BM25 implementation is not included anymore.
    We do not claim any rights on this file. However, notice the rights of the original authors, please.
    The gensim library published this and the utils.py file
    under the GNU LGPL v2.1 (http://www.gnu.org/licenses/lgpl.html) license.
"""
